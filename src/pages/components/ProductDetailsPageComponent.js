...
const ProductDetailPageComponent = ({ dispatch, addToCart }) => {
    ...
    return (
        <Container style={{ marginBottom: "130px", marginTop: "20px" }}>
            <AddToCartMessageComponent setShowCartMessage={setShowCartMessage} showCartMessage={showCartMessage} />
            <Row mt-3>
                    ...
                    <Row>
                        ...
                        <Col md={4}>
                            <ListGroup>
                                ...
                                <ListGroup.Item><Button onClick={() => addToCartHandler()} variant="success">Add to cart</Button></ListGroup.Item>
                            </ListGroup>
                        </Col>
                    </Row>
                    <Row>
